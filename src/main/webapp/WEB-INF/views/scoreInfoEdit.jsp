...
<div class="modal fade" id="editScoreInfo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="registryForm">
          ...
          <!-- 邮箱 -->
          <label for="inputUserEmail" class="registryLabel">题目</label>
          <input type="email" id="inputUserEmail" name="userEmail" class="form-control" placeholder="邮箱">
          <!-- 电话 -->
          <label for="inputPhone" class="registryLabel">平时分</label>
          <input type="text" id="inputPhone" name="userPhone" class="form-control" placeholder="电话号码">
          <label for="inputMiddle" class="registryLabel">中期成绩</label>
          <input type="text" id="inputMiddle" name="userPhone" class="form-control" placeholder="电话号码">
          <label for="inputSubmit" class="registryLabel">验收成绩</label>
          <input type="text" id="inputSubmit" name="userPhone" class="form-control" placeholder="电话号码">
          <label for="inputSummary" class="registryLabel">总成绩</label>
          <input type="text" id="inputSummary" name="userPhone" class="form-control" placeholder="电话号码">
