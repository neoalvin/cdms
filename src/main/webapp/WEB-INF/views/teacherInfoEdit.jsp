...
<div class="modal fade" id="editTeacherInfo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="registryForm">
          <!-- 学号 -->
          <label for="inputUserId" class="registryLabel">工号<span>*</span></label>
